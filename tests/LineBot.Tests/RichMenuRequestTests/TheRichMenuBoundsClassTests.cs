...
{
    [TestClass]
    public class TheRichMenuBoundsClassTests
    {
        [TestMethod]
        public void ShouldThrowExceptionWhenXIsBiggerThan2500()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>("The horizontal position cannot be bigger than 2500.", () =>
            {
                richMenuBounds.X = 2501;
            });
        }
        ...
        public void ShouldThrowExceptionWhenYIsBiggerThan1686()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>("The vertical position cannot be bigger than 1686.", () =>
            {
                richMenuBounds.Y = 1687;
            });
        }
        ...
        public void ShouldThrowExceptionWhenWidthIsBiggerThan2500()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>("The width cannot be bigger than 2500.", () =>
            {
                richMenuBounds.Width = 2501;
            });
        }
        ...
        public void ShouldThrowExceptionWhenHeightIsBiggerThan1686()
        {
            ...
            ExceptionAssert.Throws<InvalidOperationException>("The height cannot be bigger than 1686.", () =>
            {
                richMenuBounds.Height = 1687;
            });
        }
